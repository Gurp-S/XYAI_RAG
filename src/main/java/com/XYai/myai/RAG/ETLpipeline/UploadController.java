...
public class UploadController {
    ...
    public Result<String> upLoadSource(
        ...
        try {
            // 构建管道所需对象
            IngestionContext inputContext = uploadIngestionContextFactory.createFromSource(sourceUri, sourceType, collectionName, kbId);
        ...
        return buildUploadResult(1, accumulator);
    }
    ...
    private void processSingleFile(MultipartFile file, UpLoadAccumulator accumulator, String collectionName, String kbId) {
        //判断错误文件
