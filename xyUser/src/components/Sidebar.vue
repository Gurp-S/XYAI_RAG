  ...
  <aside id="sidebar" class="sidebar" :class="{ collapsed: store.isSidebarCollapsed, fullscreen: store.isFullscreen }">
    <div class="sidebar-header">
        <svg viewBox="0 0 24 24">
            <path d="M12 2.5l1.2 4.3L17.5 8l-4.1 1.6L12 14l-1.4-4.4L6.5 8l4.3-1.2z"/>
            <path d="M17 14l.5 1.8L19 16.5l-1.8.7L17 19l-.7-1.8-1.8-.7 1.8-.7z"/>
            <path d="M6 13l.4 1.4L8 15l-1.4.6L6 17l-.6-1.4L4 15l1.4-.6z"/>
        </svg>
        <span>XY-AI 引擎</span>
    </div>
    <div class="menu">
    ...
    <div class="history-container">
        ...
        <HistoryList
            ...
            :pinned-conversation-ids="store.pinnedConversationIds"
